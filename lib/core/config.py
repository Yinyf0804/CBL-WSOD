...
__C.TRAIN.PROPOSAL_NUMS = -1
__C.TRAIN.PROPOSAL_RANDOM = False
...
__C.TRAIN.BG_THRESH = 0.0

__C.TRAIN.CAM_LOW_THRESH = 0.5

__C.TRAIN.CAM_HIGH_THRESH = 0.95

__C.TRAIN.OICRLOSS = 0
...
__C.FAST_RCNN.DB_ON = True
__C.FAST_RCNN.DB_DROPOUT = False

# ---------------------------------------------------------------------------- #
# RPN options
# ---------------------------------------------------------------------------- #
__C.MODEL.RPN = AttrDict()
__C.MODEL.RPN.USE_FPN = False
# Base RPN anchor sizes given in absolute pixels w.r.t. the scaled network input
# __C.MODEL.RPN.ANCHOR_SIZES = (32, 64, 128, 256, 512)
__C.MODEL.RPN.ANCHOR_SIZES = (64, 128, 256)
# Stride of the feature map that RPN is attached.
# For FPN, number of strides should match number of scales
__C.MODEL.RPN.ANCHOR_STRIDE = (16,)
# RPN anchor aspect ratios
__C.MODEL.RPN.ASPECT_RATIOS = (0.5, 1.0, 2.0)
# Remove RPN anchors that go outside the image by RPN_STRADDLE_THRESH pixels
# Set to -1 or a large value, e.g. 100000, to disable pruning anchors
__C.MODEL.RPN.STRADDLE_THRESH = 0
# Minimum overlap required between an anchor and ground-truth box for the
# (anchor, gt box) pair to be a positive example (IoU >= FG_IOU_THRESHOLD
# ==> positive RPN example)
__C.MODEL.RPN.FG_IOU_THRESHOLD = 0.5
# Maximum overlap allowed between an anchor and ground-truth box for the
# (anchor, gt box) pair to be a negative examples (IoU < BG_IOU_THRESHOLD
# ==> negative RPN example)
__C.MODEL.RPN.BG_IOU_THRESHOLD = 0.5
# Total number of RPN examples per image
__C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 256
# Target fraction of foreground (positive) examples per RPN minibatch
__C.MODEL.RPN.POSITIVE_FRACTION = 0.5
# Number of top scoring RPN proposals to keep before applying NMS
# When FPN is used, this is *per FPN level* (not total)
__C.MODEL.RPN.PRE_NMS_TOP_N_TRAIN = 12000
__C.MODEL.RPN.PRE_NMS_TOP_N_TEST = 6000
# Number of top scoring RPN proposals to keep after applying NMS
__C.MODEL.RPN.POST_NMS_TOP_N_TRAIN = 2000
__C.MODEL.RPN.POST_NMS_TOP_N_TEST = 1000
# NMS threshold used on RPN proposals
__C.MODEL.RPN.NMS_THRESH = 0.7
# Proposal height and width both need to be greater than RPN_MIN_SIZE
# (a the scale used during training or inference)
__C.MODEL.RPN.MIN_SIZE = 0
# Number of top scoring RPN proposals to keep after combining proposals from
# all FPN levels
__C.MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN = 2000
__C.MODEL.RPN.FPN_POST_NMS_TOP_N_TEST = 2000
# Custom rpn head, empty to use default conv or separable conv
__C.MODEL.RPN.RPN_HEAD = "SingleConvRPNHead"
# ---------------------------------------------------------------------------- #
...
__C.OICR.SoftMargin_Loss = False
__C.OICR.Xav_Init = False
__C.OICR.Need_Mask = False
__C.OICR.Debug = False
__C.OICR.Test_RFFINE_NUM = 100

__C.OICR.CBL = AttrDict()

__C.OICR.CBL.LOSSWEIGHT = "none"    ### ["linear", "linear_single"]
__C.OICR.CBL.IoUThresh = "static"    ### ["static", "linear", "linear_wmil"]
__C.OICR.CBL.IoUThresh_Value = 0.5
__C.OICR.CBL.IoUThresh_START = 0.5
__C.OICR.CBL.IoUThresh_STOP = 1.0
__C.OICR.CBL.IoUThresh_NEG_Value = 0.5
__C.OICR.CBL.IoUThresh_GAMMA = 1.0
__C.OICR.CBL.IoUThresh_NoIgn = False
__C.OICR.CBL.IoUThresh_IgnBG = False
__C.OICR.CBL.LOSSWEIGHT_STARTITER = 0.0
__C.OICR.CBL.LOSSWEIGHT_STOPRATIO = 0.0
__C.OICR.CBL.Pseudo_MIL = True
__C.OICR.CBL.RCNN_UseMTlayer = False
__C.OICR.CBL.RCNN_UseMTlayer_STARTITER = 0.3
__C.OICR.CBL.RCNN_UseMTlayer_MULTIGT = False
__C.OICR.CBL.RCNN_UseMTlayer_BRANCH = "all"
__C.OICR.CBL.RCNN_UseMTlayer_TYPE = "all"
__C.OICR.CBL.RCNN_UseMTlayer_STOPITER = 2.0
__C.OICR.CBL.RCNN_UseMTlayer_FILTER_NONMS = False
__C.OICR.CBL.RCNN_UseMTlayer_IOUTHS = 0.7
__C.OICR.CBL.RCNN_UseMTlayer_SELECTBRANCH = 0
__C.OICR.CBL.RCNN_UseMTlayer_SCORE_GAMMA_TYPE = "sta"
__C.OICR.CBL.RCNN_UseMTlayer_SCORE_GAMMA = 1.0
__C.OICR.CBL.RCNN_UseMTlayer_SCORE_ENSTYPE = "lin"
__C.OICR.CBL.RCNN_UseMTlayer_SCORE_ADDLIN_VALUE = 0.5
__C.OICR.CBL.MeanTeacher_FC = False
__C.OICR.CBL.MeanTeacher_ROIFC = False
__C.OICR.CBL.MeanTeacher_ALL = False
__C.OICR.CBL.MeanTeacher_ALPHA = 0.999
__C.OICR.CBL.MeanTeacher_UPDATE = "last"
__C.OICR.CBL.MeanTeacher_UPDATE_MULTI = "refine"
__C.OICR.CBL.MeanTeacher_UPDATE_MULTI_AVGBRA = "cls"
__C.OICR.CBL.MeanTeacher_UPDATE_METHOD = "ori"
__C.OICR.CBL.TOPK_SELECT_RATIO = 0.1
__C.OICR.CBL.TOPK_SCORE_THS_RATIO = 0.5
__C.OICR.CBL.MT_REFINE = False
__C.OICR.CBL.MT_REFINE_TEST = False
__C.OICR.CBL.Test_UseMT = False
__C.OICR.CBL.Test_UseMTOnly = False
__C.OICR.CBL.Test_UseMTMean = False
__C.OICR.CBL.Test_UseMTMean2 = False
__C.OICR.CBL.Test_UseMTMean3 = False
__C.OICR.CBL.Test_UseShareMT = False

__C.OICR.CBL.CLS_WEIGHT = True
__C.OICR.CBL.REFINE_INIT_WEIGHT = "ref"
__C.OICR.CBL.EXTRA_ITER = 80000


__C.OICR.RPN = AttrDict()
# IOU >= thresh: positive example
__C.OICR.RPN.RPN_POSITIVE_OVERLAP = 0.7
# IOU < thresh: negative example
__C.OICR.RPN.RPN_NEGATIVE_OVERLAP = 0.3
__C.OICR.RPN.RPN_NEGATIVE_OVERLAP_LOW = 0.1
# If an anchor statisfied by positive and negative conditions set to negative
__C.OICR.RPN.RPN_CLOBBER_POSITIVES = False
# Max number of foreground examples
__C.OICR.RPN.RPN_FG_FRACTION = 0.5
# Total number of examples
__C.OICR.RPN.RPN_BATCHSIZE = 256

# Deprecated (outside weights)
__C.OICR.RPN.RPN_BBOX_INSIDE_WEIGHTS = (1.0, 1.0, 1.0, 1.0)
# Give the positive RPN examples weight of p * 1 / {num positives}
# and give negatives a weight of (1 - p)
# Set to -1.0 to use uniform example weighting
__C.OICR.RPN.RPN_POSITIVE_WEIGHT = -1.0

__C.OICR.RPN.ANCHOR_SCALES = [8,16,32]
# Anchor ratios for RPN
__C.OICR.RPN.ANCHOR_RATIOS = [0.5,1,2]
# Feature stride for RPN
__C.OICR.RPN.FEAT_STRIDE = [8, ]
__C.OICR.RPN.USE_GPU_NMS = True

__C.OICR.RPN.SOFT_WEIGHT = True
__C.OICR.RPN.P_LABEL = "last"
__C.OICR.RPN.LOSS_WEIGHT = 1.0
...
# For reproducibility
__C.RNG_SEED = 3
__C.RNG_SEED_Apply = True
__C.RNG_SEED_ApplyNumpy = True
__C.RNG_SEED_ApplySample = False
__C.RNG_SEED_ApplyScale = False
__C.RNG_SEED_SAMPLE = 3
__C.RNG_SEED_SCALE = 3
__C.RANDOM = True
__C.SAMPLE_TYPE = 'random'
__C.SAMPLE_SELECT_FILE = ''
